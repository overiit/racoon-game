...
export class InputController implements Tickable
{
	...
	constructor(world: GameWorld, domElement: HTMLElement)
	{
		this.world = world;
	...
	{
		if (this.inputReceiver === undefined && this.world !== undefined && this.world.cameraController !== undefined)
		{
